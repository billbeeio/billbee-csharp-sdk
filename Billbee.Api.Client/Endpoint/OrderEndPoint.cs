...
{
    /// <inheritdoc cref="Billbee.Api.Client.Interfaces.Endpoint.IOrderEndPoint" />
    public class OrderEndPoint : RestClientBaseClass, IOrderEndPoint
    {
        ...
        /// <inheritdoc />
        public ApiResult<DeliveryNote> CreateDeliveryNote(long orderId, bool includePdf = false,
        ...
        /// <inheritdoc />
        public ApiResult<Invoice> CreateInvoice(long orderId, bool includePdf = false, long? templateId = null,
            long? sendToCloudId = null)
        {
            NameValueCollection parameters = new NameValueCollection();
