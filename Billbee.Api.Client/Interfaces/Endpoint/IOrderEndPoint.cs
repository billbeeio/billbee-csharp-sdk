...
namespace Billbee.Api.Client.Interfaces.Endpoint
{
    ...
    public interface IOrderEndPoint
    {
        ...
        ApiResult<dynamic> AddTags(List<string> tags, long orderId);
        ...
        /// <param name="orderId">Id of the order, where the tags should be edited.</param>
        /// <returns>ApiResult with the result of the update operation</returns>
        ApiResult<dynamic> UpdateTags(List<string> tags, long orderId);
        ...
        ApiResult<DeliveryNote> CreateDeliveryNote(long orderId, bool includePdf = false,
        ...
        ApiResult<Invoice> CreateInvoice(long orderId, bool includePdf = false, long? templateId = null,
            long? sendToCloudId = null);
