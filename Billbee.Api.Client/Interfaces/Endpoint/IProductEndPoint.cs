...
namespace Billbee.Api.Client.Interfaces.Endpoint
{
    ...
    public interface IProductEndPoint
    {
        ...
        /// <returns></returns>
        ApiResult<GetReservedAmountResult> GetReservedAmount(string id, string lookupBy = "id",
            long? stockId = null);
        ...
        /// <returns></returns>
        ApiResult<List<ArticleImage>> AddMultipleArticleImages(long articleId, List<ArticleImage> images,
            bool replace = false);
